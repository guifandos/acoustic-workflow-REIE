...
:::: {.columns}
::: {.column width="42%"}
![](images/François_Tomb_Carlo_Ruspi_02.jpg){fig-alt="Pintura de Sísifo cargando eternamente una piedra enorme cuesta arriba, Tumba de Carlo Ruspi, François (1825)" fig-align="center" width="90%"}
:::
::: {.column width="58%"}
::: {.incremental}
...
::: {.muted .small}
*François, Tumba de Carlo Ruspi (1825) · dominio público*
:::
...
<span class="section-num">BLOQUE 2 · LA SOLUCIÓN</span>
...
:::: {.columns}
::: {.column width="18%"}
![](images/logo-targets.svg){fig-alt="Logo del paquete targets de R" fig-align="center" width="85%"}
:::
::: {.column width="82%"}
![](images/reproducibility.svg){fig-alt="Tres entradas fijas (data_raw inmutable, código R/_targets.R, renv.lock con versiones) pasan por un solo comando tar_make() y producen siempre la misma tabla: el resultado no depende de quién la corre, ni cuándo, ni en qué portátil" fig-align="center" width="96%"}
:::
::::
...
<span class="section-num">BLOQUE 3 · EL CASO EN BIOACÚSTICA</span>
...
<p class="kicker">targets en acción · el proyecto real</p>
...
::: {.muted .small}
Ya sabemos qué hace targets. Ahora vemos qué hay dentro de cada paso.
:::
...
<p class="kicker">Este proyecto · 11 objetivos</p>
...
::: {.muted .small}
Cada flecha es una dependencia que `targets` conoce y respeta.
...
<p class="kicker">targets · recálculo selectivo</p>
...
<span class="section-num">BLOQUE 4 · INTEGRACIÓN</span>
...
<div class="cheat">
<span class="st">01 Campo</span><span class="do">protocolo · hoja de despliegue · deriva de reloj</span>
<span class="row-line"></span>
<span class="st">02 Ingesta</span><span class="do"><code>data_raw/</code> intocable · una carpeta por grabador</span>
<span class="row-line"></span>
<span class="st">03 Metadatos</span><span class="do"><code>parse_metadata()</code> · valida nombre del archivo vs cabecera WAV</span>
<span class="row-line"></span>
<span class="st">04 QC</span><span class="do"><code>qc_flag()</code> · <code>qc_schedule_gaps()</code></span>
<span class="row-line"></span>
<span class="st">05 Procesado</span><span class="do"><code>compute_indices()</code> · <code>run_birdnet()</code> vía Python</span>
<span class="row-line"></span>
<span class="st">06 Tabla</span><span class="do"><code>consolidate()</code> + <code>assert_unique_key()</code></span>
<span class="row-line"></span>
<span class="st">Pegamento</span><span class="do"><code>targets::tar_make()</code> · <code>renv::snapshot()</code></span>
</div>
